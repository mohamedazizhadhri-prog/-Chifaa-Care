...
export class PatientListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.patientService.getPatients().subscribe((patients: User[]) => {
      this.allPatients = patients.map(patient => ({
        id: patient.id,
        name: `${patient.firstName} ${patient.lastName}`,
        diagnosis: patient.patientProfile?.diagnosis || 'N/A',
        lastVisit: patient.patientProfile?.lastVisit || 'N/A',
  ...
  private loadPendingBookings() {
    this.appointmentService.getAppointments({ status: 'PENDING' as any }).subscribe({
