    ...
    <footer class="footer-section" id="footer">
      <div class="footer-container">
        ...
        <div class="footer-bottom">
          ...
          <div class="copyright">
            <p>&copy; 2024 <span class="brand-chifaacare"><span class="part-chifaa">Chifaa</span><span class="part-care">Care</span></span>. All rights reserved. | We Care, Wherever You Are</p>
          </div>
        </div>
      </div>
    </footer>
