...
export class AdminService {
  ...
  createDoctor(data: { email: string; firstName: string; lastName: string; phone?: string; specialty?: string; licenseNumber?: string; password?: string }): Observable<any> {
    return this.http.post<any>(`${this.API}/admin/doctors`, data);
  }

  updateUser(id: string, data: { isActive?: boolean; role?: string; firstName?: string; lastName?: string; phone?: string; specialty?: string; licenseNumber?: string }): Observable<any> {
    return this.http.patch<any>(`${this.API}/admin/users/${id}`, data);
  }

  getSpecialties(): Observable<string[]> {
    return this.http.get<any>(`${this.API}/admin/specialties`).pipe(
  ...
  // Patient Management
  createPatient(data: { email: string; firstName: string; lastName: string; phone?: string; dateOfBirth?: string; gender?: string; address?: string; password?: string }): Observable<any> {
    return this.http.post<any>(`${this.API}/admin/patients`, data);
  }

  deletePatient(id: string): Observable<any> {
    return this.http.delete<any>(`${this.API}/admin/patients/${id}`);
  }

  // Doctor Management
  deleteDoctor(id: string): Observable<any> {
    return this.http.delete<any>(`${this.API}/admin/doctors/${id}`);
  }
}
