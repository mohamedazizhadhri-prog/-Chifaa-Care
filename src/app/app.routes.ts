...
export const routes: Routes = [
  ...
  // Admin portal
  {
    ...
    children: [
      ...
      { path: 'dashboard', loadComponent: () => import('./portals/admin/dashboard/admin-dashboard.component').then(m => m.AdminDashboardComponent) },
      { path: 'users', loadComponent: () => import('./portals/admin/users/admin-users.component').then(m => m.AdminUsersComponent) },
      { path: 'roles', loadComponent: () => import('./portals/admin/roles/admin-roles.component').then(m => m.AdminRolesComponent) },
      ...
      { path: 'appointments', loadComponent: () => import('./portals/admin/appointments/admin-appointments.component').then(m => m.AdminAppointmentsComponent) },
      { path: 'audit-logs', loadComponent: () => import('./portals/admin/audit/admin-audit-logs.component').then(m => m.AdminAuditLogsComponent) },
      { path: 'reports', loadComponent: () => import('./portals/admin/reports/admin-reports.component').then(m => m.AdminReportsComponent) },
      { path: 'settings', loadComponent: () => import('./portals/admin/settings/admin-settings.component').then(m => m.AdminSettingsComponent) }
    ]
  },
  // Patient portal
  {
  ...
  // Doctor portal
  {
    ...
    children: [
      ...
      { path: 'calendar', loadComponent: () => import('./portals/doctor/calendar/doctor-calendar.component').then(m => m.DoctorCalendarComponent) },
  ...
  // Clinic portal
  {
    ...
    children: [
      { path: '', redirectTo: 'dashboard', pathMatch: 'full' },
      { path: 'dashboard', loadComponent: () => import('./portals/clinic/dashboard/clinic-dashboard.component').then(m => m.ClinicDashboardComponent) },
      { path: 'patients', loadComponent: () => import('./portals/clinic/patients/clinic-patients.component').then(m => m.ClinicPatientsComponent) },
      { path: 'doctors', loadComponent: () => import('./portals/clinic/doctors/clinic-doctors.component').then(m => m.ClinicDoctorsComponent) },
      { path: 'appointments', loadComponent: () => import('./portals/clinic/appointments/clinic-appointments.component').then(m => m.ClinicAppointmentsComponent) },
      { path: 'reports', loadComponent: () => import('./portals/clinic/reports/clinic-reports.component').then(m => m.ClinicReportsComponent) },
      { path: 'messages', loadComponent: () => import('./portals/clinic/messages/clinic-messages.component').then(m => m.ClinicMessagesComponent) },
      { path: 'settings', loadComponent: () => import('./portals/clinic/settings/clinic-settings.component').then(m => m.ClinicSettingsComponent) },
    ]
  },
