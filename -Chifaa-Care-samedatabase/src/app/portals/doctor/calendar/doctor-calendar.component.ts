...
export class DoctorCalendarComponent implements OnInit {
  ...
  private loadAppointments() {
    ...
    console.log('[Calendar] Loading appointments for doctor:', user.id);
    ...
    this.appointmentService.getAppointments({
      ...
      next: (appointments) => {
        ...
        console.log('[Calendar] Number of appointments:', appointments?.length || 0);
        ...
        console.log('[Calendar] Total events loaded:', this.events.length);
        this.loading = false;
      },
      error: (err) => {
        console.error('[Calendar] Failed to load appointments', err);
        console.error('[Calendar] Error details:', err.error || err.message);
