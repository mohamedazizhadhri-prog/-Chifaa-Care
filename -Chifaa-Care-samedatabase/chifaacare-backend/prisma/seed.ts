...
// Set to true to seed static/test doctors. Default false to avoid hard-coded doctors.
...
async function main() {
  ...
  // --- Optionally create 5 Test Doctors ---
  if (SEED_DOCTORS) {
    ...
    console.log('ℹ️  SEED_DOCTORS is false - skipping creation of static test doctors and related data.');
  }
  ...
  if (SEED_DOCTORS) {
    ...
    console.log('Database seeded with 1 patient (no doctors were created).');
  }
}
