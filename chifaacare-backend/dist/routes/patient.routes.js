...
router.get('/doctor/mine', (0, auth_controller_1.restrictTo)('DOCTOR', 'ADMIN'), patient_controller_1.getDoctorPatients);
// Get a single patient's profile (for doctors/admins)
router.get('/:id', (0, auth_controller_1.restrictTo)('DOCTOR', 'ADMIN'), patient_controller_1.getPatientById);
