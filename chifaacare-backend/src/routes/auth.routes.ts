...
import { signup, login, protect, getSpecializations } from '../controllers/auth.controller';
...
// Routes
router.get('/specializations', getSpecializations); // Public route to get specializations
