...
export class MockPaymentService {
  ...
  static async confirmPayment(paymentIntentId: string) {
    ...
    try {
      ...
      // Do NOT auto-confirm appointments after payment (even in mock mode)
  ...
  static async createRefund(paymentId: string, amount?: number, reason?: string) {
    console.log('[MockPayment] Creating mock refund');
    ...
    try {
      ...
      console.log('[MockPayment] Refund created successfully');
      ...
      console.error('[MockPayment] Error creating refund:', error);
      throw new Error(`Failed to create mock refund: ${error.message}`);
    }
  }
}
